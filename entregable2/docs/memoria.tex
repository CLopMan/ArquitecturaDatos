...
\begin{enumerate}
    \item Se ha creado un nuevo dataframe con las siguientes columnas: \text{Id}, \textit{Fecha}, \textit{Temperatura}, \textit{Precipitación}, \textit{Viento} y \textit{Estación}.
