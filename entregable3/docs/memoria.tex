...
\begin{itemize}
    ...
    Se han elabroado tres tablas distintas sobre las que hacer las consultas en \texttt{Cassandra}  que permitan obtener cada una de estadísticas. Las tablas tienen esta forma:
\begin{table}[H]
    \centering
    \begin{tabular}{ll} 
        \toprule
...
\begin{table}[H]
    ...
    \begin{tabular}{ll} 
        \toprule
        \multicolumn{2}{c}{\large\textbf{Multas por marca, velocidad y modelo}} \\ 
        \midrule
        marca       & K\\
        modelo      & C↑\\
        num. multas & C↓\\
